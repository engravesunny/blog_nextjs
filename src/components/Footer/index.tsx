        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">最新文章</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">热门文章</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">关于我</a></li>
